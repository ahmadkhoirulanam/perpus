...
?>
	<section class="content">
				  ...
				  inner join tb_anggota a on s.id_anggota=a.id_anggota where status='PIN' order by tgl_pinjam desc");
							...
							?>
								...
								<tr>
									...
									$u_denda = $data_cek['denda'];
									$rupiah = "Rp " . number_format($u_denda, 0, ",", ".");
									...
									$dendarupiah = "Rp " . number_format($denda, 0, ",", ".");
									?>
		...
		<h4> *Note
			...
			<br> sebesar <span style="color:red; font-weight:bold;"><?php echo $rupiah; ?>/hari</span>.
		</h4>
	</section>
<?php
} else {
?>
	...
	<section class="content">
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="table-responsive">
				  ...
				  s.tgl_kembali
                  from tb_sirkulasi s inner join tb_buku b on s.id_buku=b.id_buku
				  inner join tb_anggota a on s.id_anggota=a.id_anggota where a.id_anggota='" . $_SESSION["ses_id"] . "' order by tgl_pinjam desc");
							while ($data = $sql->fetch_assoc()) {
							?>
		...
		<h4> *Note
			<br> Masa peminjaman buku adalah <span style="color:red; font-weight:bold;">7 hari</span> dari tanggal peminjaman.
			<br> Jika buku dikembalikan lebih dari masa peminjaman, maka akan dikenakan <span style="color:red; font-weight:bold;">denda</span>
			<br> sebesar <span style="color:red; font-weight:bold;"><?php
																	$sql_cek = "SELECT * FROM tb_denda";
																	$query_cek = mysqli_query($koneksi, $sql_cek);
																	$data_cek = mysqli_fetch_array($query_cek, MYSQLI_BOTH);
