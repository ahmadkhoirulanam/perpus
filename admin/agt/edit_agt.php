				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type='text' class="form-control" name="tempat_lahir" value="<?php echo $data_cek['tempat_lahir']; ?>"
							/>
						</div>
						
						<div class="form-group">
							<label>Tanggal Lahir</label>
							<input type='date' class="form-control" name="lahir" value="<?php echo $data_cek['lahir']; ?>"
							/>
						</div>
