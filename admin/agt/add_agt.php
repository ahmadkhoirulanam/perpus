				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" name="username" id="username" class="form-control" placeholder="Username Anggota">
						</div>

						<div class="form-group">
							<label>Password Anggota</label>
							<input type="text" name="password" id="password" class="form-control" placeholder="Password Anggota">
						</div>
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_anggota (id_anggota,username,password,nama,jekel,kelas,no_hp) VALUES (
           '".$_POST['id_anggota']."',
		   '".$_POST['username']."',
		   '".$password."',
          '".$_POST['nama']."',
